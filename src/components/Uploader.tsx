  ...
  return (
    ...
    >
      <input
        ref={inputRef}
        type="file"
        accept=".svg,.png,.pdf,.ai,image/svg+xml,image/png,application/pdf,application/illustrator,application/postscript"
        multiple
        disabled={disabled}
        hidden
        onChange={(e) => {
      ...
      <p className="uploader__hint">またはクリックして選択（SVG / PNG / PDF / AI・複数可）</p>
    </div>
  );
}
